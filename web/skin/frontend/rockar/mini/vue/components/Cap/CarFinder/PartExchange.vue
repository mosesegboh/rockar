                ...
                <div class="part-exchange-wrapper col-12">
                    ...
                    <div class="part-exchange-right">
                        <div class="part-exchange-skip-wrapper">
                            <div class="px-regular-heading text-center">{{ 'No vehicle to trade in?' | translate }}</div>
...
<script>
    import PartExchange from 'mini/components/CarFinder/PartExchange';
    import appPartExchangeVrm from 'mini/components/PartExchange/PartExchangeVRM';
    import appPartExchangeValuation from 'mini/components/CarFinder/PartExchangeValuation';
    import appRangeSlider from 'mini/components/Elements/RangeSlider';
    import appMoreInfo from 'core/components/Elements/MoreInfo';
    import appSelect from 'mini/components/Elements/Select';
