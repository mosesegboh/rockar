<template>
    <div class="finance-credit">
        <div class="general-preloader" v-show="ajaxLoading"><div class="show-loading"></div></div>
            <div class="row">
                <div class="col-12">
                    <div class="h-common h-heavy payment-title">Income</div>
                </div>
            </div>
        <validator name="finances">
            <div class="row">
                <div class="col-6">
                    <div class="row">
                        <div class="col-10">
                            <label :class="cssClassForRequiredLabel">{{ 'Gross Monthly Salary' | translate }}</label>
                        </div>
                        <div class="col-1">
                            <app-tooltip :tooltip-position="'top-left'" :tooltip-width="400">
                                ...
                                <div slot="tooltipContent">
                                    <p>Monthly salary before tax incl. 3 month average commission and car allowance.</p>
                                </div>
                            </app-tooltip>
                        </div>
                ...
                <div class="col-6">
                    <label class="side-label">{{ 'Commission (3 month average)' | translate }}</label>
                    <div class="finance-filter-slider-input">
                        <div class="finance-filter-slider-input-wrapper">
                            <input
                                type="text"
            ...
            <div class="row">
                <div class="col-6">
                    <label class="side-label">{{ 'Car Allowance (included in Gross)' | translate }}</label>
                    <div class="finance-filter-slider-input">
                        <div class="finance-filter-slider-input-wrapper">
                            <input
                                type="text"
                ...
                <div class="col-6">
                    <label class="side-label">{{ 'Additional Income' | translate }}</label>
                    <div class="finance-filter-slider-input">
                        <div class="finance-filter-slider-input-wrapper">
                            <input
                                type="text"
            ...
            <div class="row">
                <div class="col-6">
                    <label :class="additionalIncomeGreaterThanZero ? cssClassForRequiredLabel : 'side-label'">{{ 'Source of Additional Income' | translate }}</label>
                    <div class="finance-filter-slider-input">
                        <div class="finance-filter-slider-input-wrapper">
                            <input
                                type="text"
                ...
                <div class="col-6">
                    <div class="row">
                        <div class="col-10">
                        <label :class="cssClassForRequiredLabel">{{ 'Net/Take Home Salary' | translate }}</label>
                    </div>
                        <div class="col-1">
                        <app-tooltip :tooltip-position="'top-left'" :tooltip-width="400">
                            <span class="action-badge info-small" slot="tooltipElement"></span>
                            <div slot="tooltipContent">
                                <p>Monthly salary after tax and deductions.</p>
                            </div>
                        </app-tooltip>
                    </div>
                        <div class="finance-filter-slider-input">
            ...
            <div class="row">
                <div class="col-12">
                    <p class="px-regular-heading">{{ 'Total Income:' | translate }}</p>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="h-common h-heavy payment-title">Expenses</div>
                </div>
            </div>
            <div class="row">
                <div class="col-6">
                    <p class="field-title">{{ 'Bond:' | translate }}</p>
                    <div class="finance-filter-slider-input">
                        <div class="finance-filter-slider-input-wrapper">
                            <input
                                type="text"
                ...
                <div class="col-6">
                    <p class="field-title">{{ 'Rent Repayment:' | translate }}</p>
                    <div class="finance-filter-slider-input">
                        <div class="finance-filter-slider-input-wrapper">
                            <input
                                type="text"
            ...
            <div class="row">
                <div class="col-6">
                    <p class="field-title">{{ 'Maintenance Expenses:' | translate }}</p>
                    <div class="finance-filter-slider-input">
                        <div class="finance-filter-slider-input-wrapper">
                            <input
                                type="text"
                ...
                <div class="col-6">
                    <p class="field-title">{{ 'Household Expenses:' | translate }}</p>
                    <div class="finance-filter-slider-input">
                        <div class="finance-filter-slider-input-wrapper">
                            <input
                                type="text"
            ...
            <div class="row">
                <div class="col-6">
                    <p class="field-title">{{ 'Vehicle Instalment (Excl. to be settled):' | translate }}</p>
                    <div class="finance-filter-slider-input">
                        <div class="finance-filter-slider-input-wrapper">
                            <input
                                type="text"
                ...
                <div class="col-6">
                    <p class="field-title">{{ 'Transport Cost:' | translate }}</p>
                    <div class="finance-filter-slider-input">
                        <div class="finance-filter-slider-input-wrapper">
                            <input
                                type="text"
            ...
            <div class="row">
                <div class="col-6">
                    <p class="field-title">{{ 'Credit Card Repayment:' | translate }}</p>
                    <div class="finance-filter-slider-input">
                        <div class="finance-filter-slider-input-wrapper">
                            <input
                                type="text"
                ...
                <div class="col-6">
                    <p class="field-title">{{ 'Clothing Account:' | translate }}</p>
                    <div class="finance-filter-slider-input">
                        <div class="finance-filter-slider-input-wrapper">
                            <input
                                type="text"
            ...
            <div class="row">
                <div class="col-6">
                    <p class="field-title">{{ 'Policy Repayments:' | translate }}</p>
                    <div class="finance-filter-slider-input">
                        <div class="finance-filter-slider-input-wrapper">
                            <input
                                type="text"
                ...
                <div class="col-6">
                    <p class="field-title">{{ 'Personal Loan:' | translate }}</p>
                    <div class="finance-filter-slider-input">
                        <div class="finance-filter-slider-input-wrapper">
                            <input
                                type="text"
            ...
            <div class="row">
                <div class="col-6">
                    <p class="field-title">{{ 'Overdraft Repayment:' | translate }}</p>
                    <div class="finance-filter-slider-input">
                        <div class="finance-filter-slider-input-wrapper">
                            <input
                                type="text"
                ...
                <div class="col-6">
                    <p class="field-title">{{ 'Furniture Account:' | translate }}</p>
                    <div class="finance-filter-slider-input">
                        <div class="finance-filter-slider-input-wrapper">
                            <input
                                type="text"
            ...
            <div class="row">
                <div class="col-6">
                    <p class="field-title">{{ 'Education Cost:' | translate }}</p>
                    <div class="finance-filter-slider-input">
                        <div class="finance-filter-slider-input-wrapper">
                            <input
                                type="text"
                ...
                <div class="col-6">
                    <p class="field-title">{{ 'Rates, Water and Electricity:' | translate }}</p>
                    <div class="finance-filter-slider-input">
                        <div class="finance-filter-slider-input-wrapper">
                            <input
                                type="text"
            ...
            <div class="row">
                <div class="col-6">
                    <p class="field-title">{{ 'Telephone Payment:' | translate }}</p>
                    <div class="finance-filter-slider-input">
                        <div class="finance-filter-slider-input-wrapper">
                            <input
                                type="text"
                ...
                <div class="col-6">
                    <p class="field-title">{{ 'Food and Entertainment:' | translate }}</p>
                    <div class="finance-filter-slider-input">
                        <div class="finance-filter-slider-input-wrapper">
                            <input
                                type="text"
            ...
            <div class="row">
                <div class="col-6">
                    <p class="field-title">{{ 'Medical Aid:' | translate }}</p>
                    <div class="finance-filter-slider-input">
                        <div class="finance-filter-slider-input-wrapper">
                            <input
                                type="text"
                ...
                <div class="col-6">
                    <p class="field-title">{{ 'Other Expenses:' | translate }}</p>
                    <div class="finance-filter-slider-input">
                        <div class="finance-filter-slider-input-wrapper">
                            <input
                                type="text"
            ...
            <div class="row">
                <div class="col-6">
                    <p class="px-regular-heading">{{ 'Total Monthly Expenses:' | translate }}</p>
                    <p class="final-valuation">
                        {{ this.formatNumeral(calculateTotalExpenses) }}
                    </p>
                </div>
                <div class="col-6">
                    <p class="px-regular-heading">{{ 'Disposable Income:' | translate }}</p>
                    <p class="final-valuation">
            ...
            <div class="row">
                <div class="col-4">
                    <p class="px-regular-heading">{{ 'I am liable as' | translate }}</p>
                </div>
                <div class="col-2">
                    <input
                        type="checkbox"
            ...
            <div class="row">
                <div class="col-12">
                    <label :class="this.anyLiableSelected ? cssClassForRequiredLabel : 'side-label'">{{ 'Liability Details' | translate }}</label>
                    <div class="finance-filter-slider-input">
                        <div class="finance-filter-slider-input-wrapper">
                            <input
                                type="text"
...
import currentLocale from 'mini/components/Shared/CurrentLocale';
import uiVariables from 'mini/components/Shared/UIVariables';
