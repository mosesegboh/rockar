<template>
    <div v-if="orderData" class="order-confirmation">
        <p v-if="!tradeIn" class="order-confirm-subtitle">{{ 'Congrats! You\'ve placed your order.' | translate }}</p>
        ...
        <div class="order-confirmation-body">
            ...
            <div v-if="tradeIn">
                <p>
                    ...
                    The final or actual "Trade-In Value" for your vehicle will be confirmed once an authorised and approved MINI Retailer has inspected the vehicle.
                </p>
                <br>
                <p>Once your quote has been amended by the Retailer. You can accept the Trade-In and place your order right here</p>
            </div>

            <a :href="myAccountUrlFull" :title="'My Account' | translate" v-if="!inStore" class="button button-empty">{{ 'Go to My Profile' | translate }}</a>
