                        ...
                        >
                            ...
                            <div class="row">
                                <div class="col-3">
                                    ...
                                    >
                                        <span class="action-badge info-small" slot="tooltipElement"></span>
                                        <div slot="tooltipContent">
                                            <p>Surname as per your ID/Passport</p>
                                        </div>
                                    </app-tooltip>
                                </div>
                                <div class="col-9">
                            ...
                            <div class="row">
                                ...
                                <div class="col-9">
                                    <input
                                        ...
                                        type="tel"
                                        initial="off"
                                        v-validate:primary-number="{ mobile: [this.currentLocale, this.localeValidation[this.currentLocale].mobileRegEx] }"
                                        id="primary_number"
                                        name="primary_number"
                            ...
                            <div class="row">
                                <div class="col-3">
                                    ...
                                    <label
                                        ...
                                        v-if="!isSAID"
                                    >
                                        {{ 'Passport Number' | translate }}</label>
                                </div>
                                <div class="col-9">
                                    <input
                                        initial="off"
                            ...
                            <div class="row">
                                <div class="col-5">
                                    ...
                                    >
                                    <label for="individual"><span></span>an individual</label>
                                </div>
                                <div class="col-5">
                                    <input
                                        type="radio"
                                        ...
                                        v-model="businessPicker"
                                    >
                                    <label for="business"><span></span>a corporate company</label>
                                </div>
                                <input
                                    type="hidden"
                                    name="customer_type"
                            ...
                            <span class="order-cap-tooltip" v-show="!isBusiness && remainingRequestAmount > 0">
                                <app-tooltip :tooltip-position="'top-left'" :tooltip-width="400">
                                    <span class="action-badge info-small" slot="tooltipElement"></span>
                                     <span slot="tooltipContent">
                                         <p>{{ 'You can have up to ' | translate }} {{ remainingRequestAmount }} {{ ' active orders at a time' | translate }}</p>
                                     </span>
                                </app-tooltip>
                            ...
                            <h3 v-if="isBusiness">{{ 'Physical Address' | translate }}</h3>
                            <h3 v-if="!isBusiness">{{ 'Residential Address' | translate }}</h3>
                            <div class="row">
                                <div class="col-3">
                                    <label
                                        class="required side-label"
                                ...
                                <div class="col-9" v-if="!isBusiness">
                                    <input
                                        initial="off"
                            ...
                            <div class="row" v-if="isBusiness">
                                ...
                                <div class="col-9" v-if="postalSameAsChecked">
                                    <input
                                        initial="off"
                            ...
                            <div class="row">
                                <div class="col-9 shift-3">
                                    <div class="buttons-set">
                                        <button
                                            type="submit"
                                            class="button-default full-width"
                                        >
                                            {{ 'Submit' | translate }}
                                        </button>
                                    </div>
...
<script>
    ...
    import yourDetailsHelpers from 'mini/components/Checkout/YourDetails/helpers';
