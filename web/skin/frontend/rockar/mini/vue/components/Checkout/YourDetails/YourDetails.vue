...
<script>
    ...
    import AccordionGroup from 'mini/components/Checkout/YourDetails/AccordionGroup';
    import Accordion from 'mini/components/Checkout/YourDetails/Accordion';
    import CheckoutResidence from 'mini/components/Checkout/YourDetails/Residence';
    import CheckoutEmployment from 'mini/components/Checkout/YourDetails/Employment';
    import CheckoutAdditionalInfo from 'mini/components/Checkout/YourDetails/AdditionalInfo';
    import YourDetailsBusiness from 'core/components/Checkout/YourDetails/Business';
    import CheckoutTermsAndConditions from 'mini/components/Checkout/YourDetails/TermsAndConditions';
    import CheckoutDeposit from 'mini/components/Checkout/YourDetails/Deposit';
    import CheckoutPersonal from 'mini/components/Checkout/YourDetails/PersonalDetails';
    import CheckoutIncomeExpenses from 'mini/components/Checkout/YourDetails/IncomeExpenses';
    import CheckoutBankAccountDetails from 'mini/components/Checkout/YourDetails/BankAccountDetails';
    import CheckoutCommunicationPreferences from 'mini/components/Checkout/YourDetails/CommunicationPreferences';
    import Modal from 'core/components/Elements/Modal';
    import OtpPopup from 'mini/components/Checkout/YourDetails/OtpPopup';
