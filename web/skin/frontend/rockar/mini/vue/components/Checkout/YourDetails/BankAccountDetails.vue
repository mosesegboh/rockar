        ...
        <validator name="banking-details">
            ...
            <div class="row">
                <p>We take the privacy and protection of your personal information very seriously
                    and will only process your personal information in accordance with the current South African data privacy laws
                    and the terms of our Privacy Statement.
                </p>
            </div>
            <div class="row">
                <div class="col-6">
                    <label :class="cssClassForRequiredLabel">{{ 'Account Holder Name' | translate }}</label>
                ...
                <div class="col-6">
                    <label :class="cssClassForRequiredLabel">{{ 'Bank Name' | translate }}</label>
            ...
            <div class="row">
                <div class="col-6">
                    <label :class="cssClassForRequiredLabel">{{ 'Branch Name' | translate }}</label>
                    <div class="select-wrapper" :class="{'selected': activeFinanceGroupId > 0}">
                        <app-select
                ...
                <div class="col-6">
                    <label :class="cssClassForRequiredLabel">{{ 'Branch Code' | translate }}</label>
                    <div class="finance-filter-slider-input">
                        <div class="finance-filter-slider-input-wrapper">
                            <input
                                type="text"
            ...
            <div class="row">
                <div class="col-6">
                    <label :class="cssClassForRequiredLabel">{{ 'Account Type' | translate }}</label>
                    <div class="select-wrapper" :class="{'selected': activeFinanceGroupId > 0}">
                        <app-select
                ...
                <div class="col-6">
                    <label :class="cssClassForRequiredLabel">{{ 'Account Number' | translate }}</label>
                    <div class="finance-filter-slider-input">
                        <div class="finance-filter-slider-input-wrapper">
                            <input
                                type="text"
