...
<script>
    import appConfiguratorPartExchange from 'mini/components/Configurator/PartExchange';
    import appNavigationSteps from 'mini/components/CarFinder/NavigationSteps';
