<script>
    ...
    import appFinanceFilterMenu from 'mini/components/CarFinder/FinanceFilterMenu';
    import appPartExchangeFilterMenu from 'mini/components/CarFinder/PartExchangeFilterMenu';
        ...
        data() {
            return {
                ...
                mapping: {
                    ...
                    'variant': this.translateString('Engine Type')
                },
