...
<script>
    import FinanceQuote from 'mini/components/Shared/FinanceQuote';
    ...
    import appConfirmationModal from 'mini/components/Elements/ConfirmationModal';
    import perfectScrollbar from 'perfect-scrollbar';
    import Stickyfill from '@rq/stickyfill';
    import UrlParser from 'mini/mixins/UrlParser';
    import Constants from 'mini/components/Shared/Constants';
