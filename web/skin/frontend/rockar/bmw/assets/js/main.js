...
import brandStore from 'bmw/store';
...
import validations from 'bmw/utils/VueValidation';
        ...
        initFooter() {
            jQuery('.footer-menu').on('click', 'h4', (e) => {
                ...
                if (winWidth < 737) {
                    ...
                    submenu.slideToggle();
                    var footerParentElement = submenu.closest('.footer-menu');
                    footerParentElement.toggleClass('open');
                }
            });
        },
