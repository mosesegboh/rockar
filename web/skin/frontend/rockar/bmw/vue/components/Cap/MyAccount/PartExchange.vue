        ...
        <div class="part-exchange-regular row" v-show="!openCustom">
            <div class="part-exchange-left equal-height col-6">
                ...
                <div class="px-mileage-block">
                    <p class="px-light-text">{{ 'Your car\'s mileage is:' | translate }}</p>
                    <input type="text"
                        placeholder="0"
                        @focus="selectMileage"
...
<script>
    import corePartExchange from 'bmw/components/MyAccount/PartExchange';
    ...
    import appPartExchangeVrm from 'bmw/components/Configurator/PartExchangeVRM';
    import appPartExchangeCustomCar from 'bmw/components/PartExchange/PartExchangeCustomCar';
    import appAccountPartExchangeValuation from 'bmw/components/MyAccount/PartExchangeValuation';
