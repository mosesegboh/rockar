...
<script>
    import corePartExchange from 'bmw/components/Checkout/PartExchange';
    ...
    import appPartExchangeVrm from 'bmw/components/Cap/Checkout/PartExchangeVRM';
    import appPartExchangeCustomCar from 'bmw/components/PartExchange/PartExchangeCustomCar';
    import appCheckoutPartExchangeValuation from 'bmw/components/Checkout/PartExchangeValuation';
