...
<script>
    ...
    import AccordionGroup from 'bmw/components/Checkout/YourDetails/AccordionGroup';
    import Accordion from 'bmw/components/Checkout/YourDetails/Accordion';
    import CheckoutResidence from 'bmw/components/Checkout/YourDetails/Residence';
    import CheckoutEmployment from 'bmw/components/Checkout/YourDetails/Employment';
    import CheckoutAdditionalInfo from 'bmw/components/Checkout/YourDetails/AdditionalInfo';
    import YourDetailsBusiness from 'core/components/Checkout/YourDetails/Business';
    import CheckoutTermsAndConditions from 'bmw/components/Checkout/YourDetails/TermsAndConditions';
    import CheckoutDeposit from 'bmw/components/Checkout/YourDetails/Deposit';
    import CheckoutPersonal from 'bmw/components/Checkout/YourDetails/PersonalDetails';
    import CheckoutIncomeExpenses from 'bmw/components/Checkout/YourDetails/IncomeExpenses';
    import CheckoutBankAccountDetails from 'bmw/components/Checkout/YourDetails/BankAccountDetails';
    import CheckoutCommunicationPreferences from 'bmw/components/Checkout/YourDetails/CommunicationPreferences';
    import Modal from 'core/components/Elements/Modal';
    import OtpPopup from 'bmw/components/Checkout/YourDetails/OtpPopup';
