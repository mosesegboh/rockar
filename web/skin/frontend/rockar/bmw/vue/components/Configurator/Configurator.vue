...
import appChooseVehicleGrid from 'bmw/components/Configurator/ChooseVehicleGrid';
import appTopFinanceQuote from 'bmw/components/Configurator/TopFinanceQuote';
import appAccessories from 'bmw/components/Configurator/Accessories';
import appNavigation from 'bmw/components/Configurator/Navigation';
import UrlParser from 'bmw/mixins/UrlParser';
import appProductTopContainer from 'bmw/components/Configurator/ProductTopContainer';
import appExperiencePopup from 'bmw/components/Configurator/ExperiencePopup';
