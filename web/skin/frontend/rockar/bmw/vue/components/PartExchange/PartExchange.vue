...
<script>
    ...
    import appPartExchangeValuation from 'bmw/components/PartExchange/PartExchangeValuation';
    import appPartExchangeNegativeEquity from 'bmw/components/PartExchange/PartExchangeNegativeEquity';
