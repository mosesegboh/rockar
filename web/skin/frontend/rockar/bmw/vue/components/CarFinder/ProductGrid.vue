        ...
        <template v-if="$parent.steps[$parent.currentStep] === 'carFilter'">
            ...
            <div class="car-filter-count mobile-borders">
                ...
                <div class="car-filter-count-info-container">
                    <span class="car-filter-count-message">{{ 'Vehicles matching your search' | translate }} </span>
...
<script>
    ...
    import appProductPod from 'bmw/components/CarFinder/ProductPod';
    import appWidgetPod from 'bmw/components/CarFinder/WidgetPod'
    import appYouBuildActionBlock from 'bmw/components/CarFinder/YouBuildActionBlock';
