<template>
    <div class="row valuation-summary">
        <div class="col-12 text-center">
            ...
            <p class="px-regular-heading">{{ '*The "Trade-In Value" of your vehicle is an estimate provided and many factors that cannot be assessed without a physical inspection of the vehicle may affect actual value. The final or actual "Trade-In Value" for your vehicle will be confirmed upon physical inspection of your vehicle having been undertaken by an authorised and approved BMW retailer.' | translate }}</p>
            <div class="future-value-container" v-if="getPxFutureValueEnabled">
                <div class="future-value">
                    <hr>
                    <p v-html="getReplacedBlock"></p>
                    <hr>
                </div>
                <app-more-info class="future-value show-more" :disable="disableMoreInfo">
                    ...
                    <p slot="content" v-html="getReplacedBlock"></p>
                </app-more-info>
            </div>
        </div>
        <div class="outstanding-finance">
            ...
            <div class="input-wrapper-finance">
            ...
            <div slot="content">
                ...
                <div class="main-content">
                    <p>
                        ...
                        you may add it at a later stage by visiting your preferred BMW Retailer to get a valuation of your vehicle.
...
<script>
    ...
    import appNegativeEquityPayment from 'bmw/components/CarFinder/NegativeEquityPayment';
    import appTooltip from 'core/components/Elements/Tooltip';
    import appModal from 'core/components/Elements/Modal';
    import appSettlementPopup from 'bmw/components/AutoSettlement/SettlementPopup';
