            ...
            <div class="pod-images" :class="{'attributes-visible': attributeOverlay}">
                    ...
                    <div class="image-type-switcher">
                        <div class="actions-wrapper">
                            <button
                                class="button button-narrow button-gray-light-2"
                    ...
                    <div class="item-details-price-block">
                        ...
                        <div class="item-details-price monthly-price" v-if="cashDeposit >= 0 && monthlyPrice > 0">
                            <div class="price-wrapper">
                                ...
                                <span class="label">{{ 'Monthly Payment' | translate }}</span>
                            </div>
                        </div>
...
<script>
    import appGetQuoteCta from 'bmw/components/Elements/GetQuoteCta';
    ...
    import appCarCompare from 'bmw/components/CarFinder/CarCompare';
    import appSaveCar from 'bmw/components/CarFinder/SaveCar';
