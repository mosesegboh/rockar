            ...
            <div slot="content" class="my-saved-cars-save">
                ...
                <form :action="saveWishlistUrl" @submit="saveCar">
                    ...
                    <div class="my-saved-cars-content" v-if="!resultReceived">
                        <p class="h1">
                            {{ 'Ready to add this BMW Motorcycle to your wishlist?' | translate }}
                        </p>
                    ...
                    <div class="my-saved-cars-content" v-if="resultReceived">
                        <p class="h1">
                            {{ 'BMW Motorcycle successfully added to your wishlist.' | translate }}
                        </p>
...
<script>
    ...
    import SaveCar from 'motorrad/components/Shared/SaveCar';
    ...
    export default Vue.extend({
        ...
        data() {
            return {
                customName: `${this.customerName}, the ${this.productName}`
            };
        },
