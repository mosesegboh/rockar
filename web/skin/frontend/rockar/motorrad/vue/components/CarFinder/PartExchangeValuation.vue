<template>
    <div class="row valuation-summary">
        <div class="col-12 text-center">
            ...
            <p class="px-regular-heading px-tradein-disclaimer">{{ '*The "Trade-In Value" of your vehicle is an estimate provided and many factors that cannot be assessed without a physical inspection of the vehicle may affect actual value. ' +
                'The final or actual "Trade-In Value" for your vehicle will be confirmed upon the physical inspection of your vehicle having been undertaken by an authorised and approved BMW retailer.' | translate }}
            </p>
                    ...
                    <div class="info-label-wrap">
                        <app-tooltip :tooltip-position="'top-left'" :tooltip-width="400">
                            ...
                            <div slot="tooltipContent">
                                <p>If you are still paying off your vehicle or motorcycle, what is the amount required to settle your vehicle or motorcycle finance? If your vehicle or motorcycle is fully paid off, please leave it blank.</p>
                            </div>
                        </app-tooltip>
                    </div>
            ...
            <div slot="content">
                ...
                <div class="main-content">
                    <p>
                        ...
                        you may add it at a later stage by visiting your preferred BMW Motorrad Retailer to get a valuation of your vehicle.
...
<script>
    import PartExchangeValuation from 'motorrad/components/Shared/PartExchangeValuation';
    import numeral from 'numeral';
    import appMoreInfo from 'core/components/Elements/MoreInfo';
    import appNegativeEquityPayment from 'motorrad/components/CarFinder/NegativeEquityPayment';
    import appTooltip from 'core/components/Elements/Tooltip';
    import appModal from 'core/components/Elements/Modal';
    import appSettlementPopup from 'motorrad/components/AutoSettlement/SettlementPopup';
