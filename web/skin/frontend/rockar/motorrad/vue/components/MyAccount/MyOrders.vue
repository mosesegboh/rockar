    ...
    <div class="my-orders">
                ...
                <div class="my-orders-table col-12">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <label for="c1">
                                <span></span>
                                <p class="accept-terms-statement">{{ 'I accept the' | translate }}
                                    <a
                                        href="javascript:void(0);"
        ...
        <div class="my-orders-mobile">
                            ...
                            <div class="hero-payment" v-if="hasPartExchange">
                                <div class="hero-payment-section">
                                    ...
                                    <div v-if="partExchange.condition" class="hero-payment-block">
                                        ...
                                        <p class="payment-label">{{ 'Vehicle Condition' | translate }}</p>
                                    </div>
                                </div>
            ...
            <div class="my-orders-block my-orders-document" v-if="order.document">
                ...
                <div class="row">
                    <div class="col-3">
                        <button :disabled="!order.document.link" @click="downloadDocument(order.document.link)">{{ 'Download' | translate }}</button>
                    </div>
                </div>
            </div>
