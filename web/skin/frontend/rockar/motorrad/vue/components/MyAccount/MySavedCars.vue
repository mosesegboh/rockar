    ...
    <div class="my-saved-cars">
        <div class="my-saved-cars-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-6 saved-cars-price">
                    ...
                    <div class="row saved-cars-price-action">
                        ...
                        <app-confirmation-modal :confirmation-question="'Do you really want to Remove?' | translate">
                            <button class="button-empty-light button-narrow col-4" @click="removeCar">{{ 'Remove' | translate }}</button>
...
import appExtras from 'motorrad/components/MyAccount/MySavedCarsExtras';
