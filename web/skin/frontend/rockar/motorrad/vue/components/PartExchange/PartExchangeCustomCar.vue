<template>
    <div class="part-exchange-custom">
        ...
        <div class="row">
            ...
            <div class="col-6">
                <div class="px-regular-heading text-center">{{ 'No motorcycle or vehicle to trade in?' | translate }}</div>
        ...
        <div class="row px-custom-actions">
            <div class="two-in-row row-elements">
                ...
                <div class="row-element">
                    <button
                        :class="[customCarValid ? 'button-default' : 'button-disabled', 'full-width']"
                        @click="customCarSelect()" :disabled="!customCarValid">{{ 'Continue' | translate }}
                    </button>
                </div>
            </div>
        </div>
