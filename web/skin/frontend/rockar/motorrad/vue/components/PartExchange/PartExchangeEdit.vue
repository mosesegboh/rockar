        ...
        <div class="part-exchange-regular row">
            <div class="part-exchange-left col-3 col-md-6">
                <div class="px-vrm-block">
                    <div class="px-car-info">
                        <p>
                            {{ 'Ok, so your current vehicle\'s a' | translate }}:<br>
            ...
            <div class="part-exchange-middle col-4 col-md-6">
                <div class="px-condition-block">
                    ...
                    <app-range-slider v-if="carConditions.length" :use-id="true" :active-on-slide="true" :options="carConditions" :display-steps="true" :active="activeCondition" :is-disabled="valuationResult" custom-event="changeCarCondition" custom-event-change="changeCarCondition" v-ref:condition-slider></app-range-slider>
        ...
        <div class="part-exchange-valuation row" v-show="valuationResult">
            ...
            <div class="col-4 px-outstanding-finance">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <input type="text" v-model="outstandingFinance | numberInputFormat" class="px-input keyboard-numbers">
                    </div>
                </div>
