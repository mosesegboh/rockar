...
<script>
    import corePartExchange from 'motorrad/components/Checkout/PartExchange';
    ...
    import appPartExchangeVrm from 'motorrad/components/Cap/Checkout/PartExchangeVRM';
    import appPartExchangeCustomCar from 'motorrad/components/PartExchange/PartExchangeCustomCar';
    import appCheckoutPartExchangeValuation from 'motorrad/components/Checkout/PartExchangeValuation';
