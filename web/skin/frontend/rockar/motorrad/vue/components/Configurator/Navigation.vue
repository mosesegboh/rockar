        ...
        <div class="configurator-actions row">
            <template v-if="currentDevice !== 'mobile'">
                <div class="nav-buttons">
                    <div class="configurator-actions-desktop" :class="[currentDevice !== 'mobile' ? 'col-4' : 'col-1']">
                    ...
                    <div class="configurator-actions-desktop shift-4" :class="[currentDevice !== 'mobile' ? 'col-4' : 'col-1']">
                        <button class="button button-narrow button-gray-light nav-buttons" @click="moveNext">
                            <template v-if="currentDevice !== 'mobile'">
