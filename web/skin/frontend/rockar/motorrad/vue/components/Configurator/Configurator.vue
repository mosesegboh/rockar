        ...
        <div :class="['section-wrap', activeStep]">
            <div :class="['configurator-wrap', 'section', activeStep === 'details' ? 'active' : '']">
                ...
                <div class="sub-navigation desktop">
                    ...
                    <button
                        class="button-gray-light-2 btn-sub-navigation car-extras-tab btn-features"
                        :class="[isCarExtrasContentVisible ? 'car-extras-tab-active' : 'car-extras-tab-hover']"
                        @click="showOrHideCarExtrasContent()">
                        <span class="title col-10">{{ 'Extras on this vehicle' | translate }}</span>
                    ...
                    <div class="configurator-mobile-actions-wrapper">
                        ...
                        <div class="scroll-to-features-element-btns">
                            <button
                                ...
                                {{ 'Standard Features&nbsp' | translate }}
                            </button>
...
import appSaveCar from 'motorrad/components/SaveCar';
import appChooseVehicleGrid from 'motorrad/components/Configurator/ChooseVehicleGrid';
import appTopFinanceQuote from 'motorrad/components/Configurator/TopFinanceQuote';
import appAccessories from 'motorrad/components/Configurator/Accessories';
import appNavigation from 'motorrad/components/Configurator/Navigation';
import UrlParser from 'motorrad/mixins/UrlParser';
import appProductTopContainer from 'motorrad/components/Configurator/ProductTopContainer';
import appExperiencePopup from 'motorrad/components/Configurator/ExperiencePopup';
