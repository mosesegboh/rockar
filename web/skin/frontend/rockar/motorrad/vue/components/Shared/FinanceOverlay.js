...
import AjaxHelper from 'motorrad/components/Shared/AjaxHelper';
...
export default {
    ...
    compiled() {
        ...
        // Get finance filter from the CarFinder component if it can be found
        while (parent) {
            if (parent.$options.name === 'app-car-finder') {
                financeFilter = parent.FinanceFilter;
        ...
        if (financeFilter) {
            this.financeParams.balloonPercentage = financeFilter.balloonPercentage;
        }
    },
