        ...
        <div class="row">
            <validator name="summary">
                <div class="col-12 content">
                    <div v-if="!tradeIn">
                        <div class="deliver">
                            <p>{{ 'You\'ve chosen your BMW Motorcycle, now place your order to start making Life a Ride.' | translate }}</p>
                        </div>
                        <div class="row">
                            <div class="col-12">
                    ...
                    <div v-if="tradeIn">
                        <div class="row">
                            <div class="col-12">
                                <p>{{ 'You\'ve chosen your motorcycle, now get a custom quote mailed to you.' | translate }}</p>
                    ...
                    <div class="row">
                        <div :class="[tradeIn ? 'col-5 shift-7' : 'col-4 shift-8']">
                            <div class="button-wrapper align-right">
                                <button
                                    class="button place-order"
                                    :class="[isValid ? 'button-dark' : 'button-disabled', tradeIn ? 'long-text' : '']"
                                    @click="submit()"
                                    :disabled="this.submitDisabled || !this.isValid"
                                >
                                        <span>
                                            <span>{{ tradeIn ? 'Reserve your BMW Motorcycle' : 'Place Order' | translate }}</span>
                                        </span>
                                </button>
                            </div>
                        </div>
