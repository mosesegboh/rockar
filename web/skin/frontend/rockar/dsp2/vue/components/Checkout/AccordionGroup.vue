<script>
    ...
    export default coreAccordionGroup.extend({
        ...
        watch: {
             ...
             */
            'openStep'(stepIndex) {
                this.$store.commit('setActiveStepIndex', stepIndex);
        ...
        methods: {
            showStep(step) {
                this.$dispatch('CheckoutAccordionGroup::showStep', step);
            }
        },

        events: {
            'CheckoutAccordionGroup::showStep'(step) {
                const currentStepIndex = +step ? step : this.getStepIndex(step);
                this.openStep = currentStepIndex;
