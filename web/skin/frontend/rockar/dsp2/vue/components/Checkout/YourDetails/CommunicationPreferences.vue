<template>
    <div class="finance-credit finance-credit-preferences">
        ...
        <div class="row">
            <div class="col-5 col-pt-10-20">
                <label :class="cssClassForRequiredLabel" class="dsp2-body-s">
                    {{ preferredCommunicationText | translate }}
                </label>
            </div>
            <div class="col-2">
                <input
        ...
        <div class="row">
            <div class="col-5">
                <label :class="cssClassForRequiredLabel" class="dsp2-body-s">
                    {{ contractDocumentationText | translate }}
                </label>
            </div>
            <div class="col-2">
                <input
        ...
        <div class="row border-bottom">
            <div class="col-5">
                <label :class="cssClassForRequiredLabel" class="dsp2-body-s">{{ frequencyText | translate }}</label>
            </div>
            <div class="col-2">
                <input
                    type="checkbox"
...
<script>
    ...
    export default Vue.extend({
        ...
        computed: {
            ...
            contractDocumentationText() {
                return 'Contract Documentation';
            },

            frequencyText() {
                return 'Statement Frequency';
            }
        },
