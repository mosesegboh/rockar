<template>
    <div class="finance-credit">
        ...
        <validator name="deposit">
            <div class="row-grid">
                <div class="col-6">
                    <label class="hover-label"><div>{{ 'Deposit Amount' | translate }}</div></label>
                ...
                <div class="col-6">
                    <label :class="getConditionalCssClass()" class="hover-label"><div>{{ 'Source of Deposit' | translate }}</div></label>
            ...
            <div class="row" v-if="formData.deposit.sourceOfDeposit === 'SODOT' && !depositIsZero">
                <div class="col-6">
                    <label class="hover-label"><div :class="cssClassForRequiredLabel">{{ 'Source of Deposit Description' | translate }}</div></label>
                    <div class="finance-filter-slider-input">
                        <div class="finance-filter-slider-input-wrapper">
                            <input
                                type="text"
