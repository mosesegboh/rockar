<template>
    <div class="your-details">
        ...
        <div class="step-header">{{ stepHeaderText | translate }}</div>
        ...
        <template v-else>
            <div class="your-details-title">{{ detailsTitleText | translate }}</div>
            <div v-show="!termsAccepted">
                <checkout-terms-and-conditions
                    @success="submitTerms">
                </checkout-terms-and-conditions>
            </div>
            <div v-show="termsAccepted">
                <modal class-name="otp-popup" :show="showOtpPopup" :show-close="true">
                    <div slot="content">
                        <otp-popup
...
<script>
    ...
    import AccordionGroup from 'dsp2/components/Checkout/YourDetails/AccordionGroup';
    import Accordion from 'dsp2/components/Checkout/YourDetails/Accordion';
    import CheckoutResidence from 'dsp2/components/Checkout/YourDetails/Residence';
    import CheckoutEmployment from 'dsp2/components/Checkout/YourDetails/Employment';
    import CheckoutAdditionalInfo from 'dsp2/components/Checkout/YourDetails/AdditionalInfo';
    import YourDetailsBusiness from 'core/components/Checkout/YourDetails/Business';
    import CheckoutTermsAndConditions from 'dsp2/components/Checkout/YourDetails/TermsAndConditions';
    import CheckoutDeposit from 'dsp2/components/Checkout/YourDetails/Deposit';
    import CheckoutPersonal from 'dsp2/components/Checkout/YourDetails/PersonalDetails';
    import CheckoutIncomeExpenses from 'dsp2/components/Checkout/YourDetails/IncomeExpenses';
    import CheckoutBankAccountDetails from 'dsp2/components/Checkout/YourDetails/BankAccountDetails';
    import CheckoutCommunicationPreferences from 'dsp2/components/Checkout/YourDetails/CommunicationPreferences';
    import Modal from 'core/components/Elements/Modal';
    import OtpPopup from 'dsp2/components/Checkout/YourDetails/OtpPopup';
    ...
    export default Vue.extend({
        ...
        computed: {
            ...
            checkoutDetailsAccordionShow() {
                return this.$root.$refs.checkoutDetailsAccordion.show;
            },

            stepHeaderText() {
                return 'Choose Your Payment Option';
            },

            detailsTitleText() {
                return 'For your added convenience, you can apply for finance, online, with BMW Financial Services.';
            },

            communicationsTitleText() {
        ...
        methods: {
            ...
            onAccordionShow(accordion) {
                if (this.$root.$refs.financeQuote.payInFullPayment.find(payment => payment.group_id === this.$root.$refs.financeQuote.activePayment.group_id) !== undefined) {
                    ...
                    this.activeComponentIndex = this.depositIsZero ? 1 : 0;
        ...
        watch: {
            'checkoutDetailsAccordionShow'(newValue) {
                if (newValue) {
                    /**
                     * Fire event for tracking purposes on initial load of application details
                     */
                    this.fireEventForTracking(
                        this.getEventConstants().PAGEDESCRIPTION.VIEWS,
                        this.getEventConstants().EVENTRACKERVALUES.CHECKOUTAPPLICATION
                    );
                }
            }
        },
        ...
        events: {
            ...
            'CheckoutCreditAppAccordionGroup::Cancel'() {
                ...
                this.incrementScreenIndex(this.depositIsZero ? this.indexHelper.deposit : this.indexHelper.terms);
            },
