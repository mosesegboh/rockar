<template>
    <div class="finance-credit">
        ...
        <validator name="personalDetails">
            <div class="row-grid">
                <div class="col-6">
                    <label class="hover-label"><div>{{ 'Home Telephone Number' | translate }}</div></label>
                ...
                <div class="col-6">
                    <label class="hover-label"><div :class="cssClassForRequiredLabel">{{ 'Gender' | translate }}</div></label>
            ...
            <div class="row-grid">
                <div class="col-6">
                    <label class="hover-label"><div :class="cssClassForRequiredLabel">{{ 'Ethnic Group' | translate }}</div></label>
                ...
                <div class="col-6">
                    <label class="hover-label"><div :class="cssClassForRequiredLabel">{{ 'Preferred Language' | translate }}</div></label>
                    <div class="select-wrapper" :class="{'selected': activeFinanceGroupId > 0}">
                        <app-select
                            title="-"
            ...
            <div class="row-grid row-grid-hard">
                <div class="col-6">
                    <label class="hover-label"><div :class="cssClassForRequiredLabel">{{ 'Marital Status' | translate }}</div></label>
                    <div class="select-wrapper" :class="{'selected': activeFinanceGroupId > 0}">
                        <app-select
                            title="-"
                ...
                <div class="col-6" v-if="isMarried">
                    <label class="hover-label"><div :class="cssClassForRequiredLabel">{{ 'Marital Contract' | translate }}</div></label>
                    <div class="select-wrapper" :class="{'selected': activeFinanceGroupId > 0}">
                        <app-select
                            title="-"
            ...
            <div class="row-grid" v-if="spouseDetailsRequired">
                <div class="col-6">
                    <label class="hover-label"><div :class="cssClassForRequiredLabel">{{ 'Spouse Name' | translate }}</div></label>
                    <div class="finance-filter-slider-input">
                        <div class="finance-filter-slider-input-wrapper">
                            <input
                                type="text"
                ...
                <div class="col-6">
                    <label class="hover-label"><div :class="cssClassForRequiredLabel">{{ 'Spouse Surname' | translate }}</div></label>
                    <div class="finance-filter-slider-input">
                        <div class="finance-filter-slider-input-wrapper">
                            <input
                                type="text"
            ...
            <div class="row-grid" v-if="spouseDetailsRequired">
                <div class="col-6">
                    <label class="hover-label"><div :class="cssClassForRequiredLabel">{{ 'Spouse ID Type' | translate }}</div></label>
                    <div class="select-wrapper" :class="{'selected': activeFinanceGroupId > 0}">
                        <app-select
                            title="-"
                ...
                <div class="col-6">
                    <label class="hover-label"><div :class="cssClassForRequiredLabel">{{ 'Spouse ID Number' | translate }}</div></label>
                    <div class="finance-filter-slider-input">
                        <div class="finance-filter-slider-input-wrapper">
                            <input
                                type="text"
            ...
            <div class="row-grid" v-if="spouseDetailsRequired">
                <div class="col-6">
                    <label class="hover-label"><div :class="cssClassForRequiredLabel">{{ 'Spouse Mobile Number' | translate }}</div></label>
                    <div class="finance-filter-slider-input">
                        <div class="finance-filter-slider-input-wrapper">
                            <input
                                type="text"
                ...
                <div class="col-6">
                    <label class="hover-label"><div :class="cssClassForRequiredLabel">{{ 'Spouse Email Address' | translate }}</div></label>
                    <div class="finance-filter-slider-input">
                        <div class="finance-filter-slider-input-wrapper">
                            <input
                                type="text"
            ...
            <div class="row-grid">
                <div class="col-6">
                    <label class="hover-label"><div :class="cssClassForRequiredLabel">{{ 'Next of Kin Full Name' | translate }}</div></label>
                    <div class="finance-filter-slider-input">
                        <div class="finance-filter-slider-input-wrapper">
                            <input
                                type="text"
                ...
                <div class="col-6">
                    <label class="hover-label"><div :class="cssClassForRequiredLabel">{{ 'Next of Kin Mobile Number' | translate }}</div></label>
                    <div class="finance-filter-slider-input">
                        <div class="finance-filter-slider-input-wrapper">
                            <input
                                type="text"
