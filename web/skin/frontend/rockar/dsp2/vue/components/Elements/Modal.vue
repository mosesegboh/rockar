    ...
    export default Vue.extend({
        ...
        watch: {
            'show'(isOpening) {
                ...
                if (isOpening && this.blurBackground) {
                ...
                if (this.stepParent) {
                    if (isOpening) {
                        this.realParent = jQuery(this.$el).parent();
                        jQuery(this.$el).appendTo(jQuery(this.stepParent));
                    }

                    if (!isOpening && this.realParent) {
                        jQuery(this.$el).appendTo(this.realParent);
                    }
                }
            }
        },
        ...
        ready() {
            if (this.show && this.blurBackground) {
                jQuery('body').addClass('modal-open');
            }
