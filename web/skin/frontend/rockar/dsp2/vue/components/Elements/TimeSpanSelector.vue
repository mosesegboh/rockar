<template>
    <div class="time-span-selector">
        <div class="title dsp2-body-s" :class="labelClass">{{ label }}</div>
        <div class="row-grid-sub">
            <div class="col-6">
                <label class="hover-label">
                    <div :class="labelClass">{{ 'Years' | translate }}</div>
                </label>
                <input
                    type="text"
                    placeholder="-"
            ...
            <div class="col-6">
                <label class="hover-label">
                    <div :class="labelClass">{{ 'Months' | translate }}</div>
                </label>
                <app-select
