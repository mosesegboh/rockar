<template>
    <div>
        <button @click="getQuoteCta" class="button get-quote-cta-icon" :class="getEmailQuoteClass">
                ...
                <div class="get-quote-popup-success" v-if="showPopupStep('success')">
                    ...
                    <div class="row">
                        <p>
                            ...
                            {{ quoteName }} {{ `has also been added to the wishlist located in` | translate }}
...
export default Vue.extend({
    mixins: [ajaxHelper, EventTracker],
    ...
    methods: {
        ...
        getQuoteCta() {
            if (!this.customerIsLoggedIn) {
                ...
                this.$dispatch('FinanceQuote::adjustMobileQuote', true);
                this.openPopup();
                this.fireEventForTracking(
                    this.getEventConstants().PAGEDESCRIPTION.TRIGGERS,
                    `${this.getEventConstants().TRIGGERTRACKERVALUES.QUOTEOPEN}${this.$parent.title}${this.$parent.subtitle}`
                );
            }
        },
        ...
        closePopup() {
            ...
            this.popupStep = '';
            this.$dispatch('FinanceQuote::adjustMobileQuote');
        },

        /**
         * Re-open Finance Quote on mobile view
         */
        reopenFinanceQuote() {
            this.$dispatch('FinanceQuote::adjustMobileQuote');
        },
        ...
        getQuoteSuccess(data) {
            ...
            this.fireEventForTracking(
                this.getEventConstants().PAGEDESCRIPTION.TRIGGERS,
                `${this.getEventConstants().TRIGGERTRACKERVALUES.QUOTESUCCESS}${this.$parent.title}${this.$parent.subtitle}`
            );
        },
