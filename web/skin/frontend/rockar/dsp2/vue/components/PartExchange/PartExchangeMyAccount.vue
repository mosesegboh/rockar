<template>
    <div>
        <app-part-exchange-core
            ...
            :settlement-terms-url="settlementTermsUrl"
            :reset-url="resetUrl"
            ...
            :saved-px="savedPx"
            :is-used-in-finance="isUsedInFinance"
            :temp-px="tempPx"
            ...
            :can-edit="canEdit"
            :part-exchange-filter="partExchangeFilter"
            :part-exchange-info-block="partExchangeInfoBlock"
            :dropdown-layout="true"
            :customer-is-logged-in="true"
    ...
    export default Vue.extend({
        ...
        computed: {
            ...
            partExchangeInfoBlock() {
                return this.$root.$refs.partExchangeBlock.$refs.partExchangeInfoBlock;
            }
        },
