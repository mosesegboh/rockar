    ...
    export default appMaps.extend({
        props: {
            ...
            markerIcon: {
                required: false,
                type: String,
                default: '/skin/frontend/rockar/dsp2/images/map/map-marker.png'
            },

            activeMarkerIcon: {
                required: false,
                type: String,
                default: '/skin/frontend/rockar/dsp2/images/map/map-marker-active.png'
            },

            userMarkerIcon: {
                required: false,
                type: String,
                default: '/skin/frontend/rockar/dsp2/images/map/map-marker-user.png'
            }
        },
