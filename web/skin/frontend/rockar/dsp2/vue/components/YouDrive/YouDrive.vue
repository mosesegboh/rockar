                        ...
                        <div class="map-ui-wrapper" v-show="dealerStateStep === 2 && showMapWrapper">
                            ...
                            <div class="dealers row">
                                <div class="dealer-info">
                                    <template v-for="(index, store) in storesSorted">
                                        <div class="dealer-box" v-if="localStore.id === store.id" :key="index">
                                            <app-models
...
<script>
    ...
    import appCarouselModel from 'dsp2/components/YouDrive/CarouselModel';
    import appModal from 'core/components/Elements/Modal';
    import appTimepicker from 'dsp2/components/Elements/TimePicker';
    import appMaps from 'dsp2/components/YouDrive/Maps';
    import appModels from 'dsp2/components/YouDrive/Models';
    import appSummary from 'dsp2/components/YouDrive/Summary';
    ...
    import appNavigationSteps from 'dsp2/components/YouDrive/NavigationSteps';
    import appBottomNavigation from 'dsp2/components/YouDrive/BottomNavigation';
    ...
    export default Vue.extend({
        ...
        methods: {
            ...
            saveBookingSuccess(resp) {
                ...
                this.fireEvent(this.currentState);
            },
            ...
            /**
             * Fire event for tracking purposes on initial load of test drive pages
             * and for successful booking/request
             */
                ...
                switch (currentState) {
                    case this.state.MODEL:
                        this.fireEventForTracking(
                            ...
                            this.getEventConstants().EVENTRACKERVALUES.TDVEHICLE
                        );

                        break;
                    case this.state.SUMMARY:
                        if (this.isTDRequest()) {
                            this.fireEventForTracking(
                                this.getEventConstants().PAGEDESCRIPTION.VIEWS,
                                this.getEventConstants().EVENTRACKERVALUES.TDREQUEST
                            )
                        } else {
                            this.fireEventForTracking(
                                this.getEventConstants().PAGEDESCRIPTION.VIEWS,
                                this.getEventConstants().EVENTRACKERVALUES.TDCONFIRMATION
                            );
                        }
