...
class Peppermint_FinancingOptions_Model_Calculation_Type_Leasing extends Rockar_FinancingOptions_Model_Calculation_Type_Leasing
{
    ...
    /**
     * Peppermint_FinancingOptions_Model_Calculation_Type_Leasing constructor.
     */
    ...
    /**
     * Return 0 as select finance has no balloon data.
     *
     * @return float
     */
    ...
    public function getInterestRate(): float
    {
        ...
        if ($interestRateCalc && $interestRateCalc != '$result = $interestRate;') {
            ...
            $interestRate = $this->_customCalculation->interestRate(
                $subventionAmount,
                $subventionRate,
                $interestRate
            );
