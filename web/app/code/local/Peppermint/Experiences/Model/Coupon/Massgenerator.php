...
class Peppermint_Experiences_Model_Coupon_Massgenerator extends Mage_Core_Model_Abstract
    implements Mage_SalesRule_Model_Coupon_CodegeneratorInterface
{
    ...
    public function generateCode()
    {
        ...
        if (!$format) {
            $format = Peppermint_Experiences_Helper_Coupon::COUPON_FORMAT_ALPHANUMERIC;
        }
        ...
        $charset = Mage::helper('peppermint_experiences/coupon')->getCharset($format);
    ...
    public function getDelimiter()
    {
        if ($this->getData('delimiter')) {
            ...
            return Mage::helper('peppermint_experiences/coupon')->getCodeSeparator();
        }
    }
    ...
    public function generatePool()
    {
        ...
        /** @var $coupon Peppermint_Experiences_Model_Coupon */
        $coupon = Mage::getModel('peppermint_experiences/coupon');

        $chars = count(Mage::helper('peppermint_experiences/coupon')->getCharset($this->getFormat()));
        ...
        for ($i = 0; $i < $size; $i++) {
            ...
            do {
                if ($attempt >= $maxAttempts) {
                    Mage::throwException($this->__('Unable to create requested Coupon Qty. Please check settings and try again.'));
                }
            ...
            $coupon->setId(null)
                ...
                ->setCreatedAt($now)
                ->setType(Peppermint_Experiences_Helper_Coupon::COUPON_TYPE_SPECIFIC_AUTOGENERATED)
                ->setCode($code)
                ->save();
