...
$installer = $this;
$vinProductPricingArchiveTable = $installer->getTable('peppermint_reports/vin_product_pricing_log_archive');

$connection = $installer->getConnection();
$installer->startSetup();

/**
 * Create table 'vin_product_pricing_log_archive'
 */
$table = $connection->newTable($vinProductPricingArchiveTable)
    ->addColumn(
        'id',
    ...
    ->setComment('VIN Product Pricing Logs Archive');
