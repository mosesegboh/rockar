...
class Peppermint_Sales_Block_Adminhtml_Report_ProductOrderPricing_Renderer_ShortfallApplied
    extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract
{
    ...
    public function render(Varien_Object $row)
    {
        ...
        $index = array_search('shortfall_applied', array_column($financeDataVariables, 'variable'));
        $value = '';
